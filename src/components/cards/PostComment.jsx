...
const PostComment = ({ user, setNewComment, post_ID, comments, setCommentPosting, commentPosting, isNewComment = true }) => {
  ...
  const handleSubmit = async e => {
    e.preventDefault();
    handleReply(e, replyContent, user, post_ID, setNewComment, comments, setCommentPosting, setIsPosting, setIsSuccess, setIsFail, setErrorMessage);
  };
        ...
        <form className="w-full mb-4" onSubmit={handleSubmit}>
          <div className="relative w-full border rounded-md border-gray-400 overflow-hidden p-2">
            ...
            <div className="w-full flex justify-end bg-slate-100 rounded p-2">
              {!isNewComment && <div className="btn-cancel hover:cursor-pointer">Cancel</div>}
