  ...
  return (
    <section>
      <div className="flex flex-grow p-0 md:p-2 flex-col " id="main-feeds">
        ...
        <div className="w-full bg-neutral-100 shadow-md border rounded-md border-slate-200 flex flex-col md:flex-row p-0 md:p-2 h-[220px]">
          <div className="shrink-0 w-full md:w-[350px] h-fit">
            {post.slug ? (
              <Link href={post.slug}>
                <Image src={post?.thumbnail_url} alt={post.post_title} priority={true} width={350} height={225} sizes="(min-width: 768px) 350px" className="md:rounded-md object-cover w-full md:w-[350px] md:h-[200px]" />
              </Link>
            ) : (
              <Image src={post?.thumbnail_url} alt={post.post_title} priority={true} width={350} height={225} sizes="(min-width: 768px) 350px" className="md:rounded-md object-cover w-full md:w-[350px]  md:h-[200px]" />
            )}
          </div>
          <div className="flex flex-col min-h-[118px] h-full px-1 md:px-2">
            <div>
            ...
            <div className="flex justify-between font-ibm py-1 text-sm mt-2 border-t border-slate-300">
